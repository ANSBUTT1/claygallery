    ...
    <>
      <main className="px-16 py-8">
        <div className="text-primary mb-12 ">
          <h1 className="uppercase text-xl mb-4">Trending Now</h1>
          <p className=" text-2xl md:text-3xl  lg:text-5xl text-center sm:text-start ">
            Minimalist ClayGallery Designs
          </p>
        </div>
